<?php
      ...
      if($act == "Interview") {
            $where = "where department = '{$department}' or department1 = '{$department}' or department2 = '{$department}' or department3 = '{$department}'";
      }
      ...
      $sql    = "select id, name  from student {$where} order by id asc limit {$offset}, {$pageSize}";
      $rows = fetchAll($sql);
      if (!$rows) {
...
<html>
      ...
      <body>
            <div class="details">
                                <div class="details_operation clearfix">
                                    <div class="bui_select">
                                        <input type="button" value="面试列表" class="add"  >
                                    </div>
            ...
            <script type="text/javascript">
                  ...
                  function seeCate(id) {
                        window.location="see_about.php?id="+id;
                  }
